...
Citizen.CreateThread(function()
    ...
    FinanceOrganization.Name.Set("Dunder Mifflin", FinanceOrganization.Name.Style.normal, FinanceOrganization.Name.Colors.black, FinanceOrganization.Name.Fonts.font13)
