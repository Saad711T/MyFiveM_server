local blips = {
	...
	{text = "The Rebel", color = 1, sprite = 40, coord = vector3(1274.65, -1720.83, 54.68)},
	
	-- Lester's Factory 
    {text = "Garment's Factory", color = 3, sprite = 475, coord = vector3(717.93, -976.46, 24.91)},
...
--    {text = "Aircraft Carrier", color = 0, sprite = 16, coord = vector3(3082.31, -4717.11, 15.26)},
    ...
    {text = "Cluckin' Bell Factory", color = 4, sprite = 106, coord = vector3(-71.49, 6266.47, 31.15)},
    ...
    {text = "Prison", color = 47, sprite = 526, coord = vector3(1851.78, 2606.26, 45.67)},
